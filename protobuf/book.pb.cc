...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Person_book_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Person_book_2eproto}, {}};
...
const char descriptor_table_protodef_book_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "age\030\002 \002(\005\022\r\n\005email\030\003 \001(\t"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_book_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_book_2eproto_sccs[1] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_book_2eproto = {
  false, false, descriptor_table_protodef_book_2eproto, "book.proto", 64,
  &descriptor_table_book_2eproto_once, descriptor_table_book_2eproto_sccs, descriptor_table_book_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_book_2eproto::offsets,
  file_level_metadata_book_2eproto, 1, file_level_enum_descriptors_book_2eproto, file_level_service_descriptors_book_2eproto,
};
